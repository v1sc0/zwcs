...
(function(exports){
     ...
     */
      var encodeText = function (text1, text2, position) {
        return combine_shuffle_string(text1, encode_to_zerowidth_characters_text(text2), codelengthText, position);
    };
    /**
      Binary Encoder
      args:
    ...
    */
    ...
    var combine_shuffle_string = function (str1, str2, codelength, position) {
      var result = [];
      ...
      if (position === 'beginning') {
          ...
          result = result.concat(c1.slice(i)).concat(c2.slice(j));
      }
